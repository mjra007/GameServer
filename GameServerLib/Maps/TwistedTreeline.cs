...
namespace LeagueSandbox.GameServer.Maps
{
    internal class TwistedTreeline : IMapProperties
    {
        ...
        public void Init()
        {
            ...
            _blueOuterTurrets.Add(new LaneTurret(_game, "Turret_T1_L_03_A", "OrderTurretNormal", new Vector2(3950f, 8000f), TeamId.TEAM_BLUE,
            ...
            _blueInnerTurrets.Add(new LaneTurret(_game, "Turret_T1_L_02_A", "OrderTurretNormal2", new Vector2(1290f, 8590f), TeamId.TEAM_BLUE,
        ...
        public Tuple<TeamId, Vector2> GetMinionSpawnPosition(string spawnPosition)
        {
            switch (spawnPosition)
            {
                case Barracks.SPAWN_BLUE_TOP:
                    return new Tuple<TeamId, Vector2>(TeamId.TEAM_BLUE, new Vector2(1500, 6500));
                case Barracks.SPAWN_BLUE_BOT:
                    return new Tuple<TeamId, Vector2>(TeamId.TEAM_BLUE, new Vector2(1500, 6100));
